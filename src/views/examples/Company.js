...
const Company = () => {
  ...
  const handleRowUpdate = async (newData, oldData, resolve) => {
    ...
    let result = await fetch(`https://server-production-3f74.up.railway.app/update/${newData._id}`, {
      method: "put",
      body: JSON.stringify({
        newData,
      }),
  ...
  const handleRowDelete = async (oldData, resolve) => {
    ...
    let result = await fetch(`https://server-production-3f74.up.railway.app/delete/${oldData._id}`, {
      method: "delete",
  ...
  const firmSubmit = async (e) => {
    ...
    let result = await fetch("https://server-production-3f74.up.railway.app/createFirm", {
      method: "post",
      body: JSON.stringify({
        firmname: firmname,
        email: email,
