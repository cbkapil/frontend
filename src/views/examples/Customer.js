...
const Company = () => {
  ...
  const handleRowUpdate = async (newData, oldData, resolve) => {
    ...
    let result = await fetch(`https://server-production-3f74.up.railway.app/updatecustomer/${newData._id}`, {
      method: "put",
      body: JSON.stringify({
        newData,
      }),
  ...
  const handleRowDelete = async (oldData, resolve) => {
    ...
    let result = await fetch(`https://server-production-3f74.up.railway.app/deletee/${oldData._id}`, {
      method: "delete",
  ...
  const getFirm = async () => {
    let result = await fetch("https://server-production-3f74.up.railway.app/getfirm", {
      method: "GET",
  ...
  const getcustomerdata = async () => {
    let result = await fetch("https://server-production-3f74.up.railway.app/getcustomerdata", {
      method: "GET",
  ...
  const success = () => {toast.success('Firm Data Added Successfully !!!!', {
    ...
    const firmSubmit = async (e) => {
      ...
      let result = await fetch("https://server-production-3f74.up.railway.app/createparty", {
        method: "post",
        body: JSON.stringify({
          customername,
          email,
