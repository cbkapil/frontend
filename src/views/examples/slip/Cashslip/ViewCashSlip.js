...
const ViewCashSlip = () => {
  ...
  const searchbydate = async () => {
    ...
    if (startDate && endDate) {
      let result = await fetch("https://server-production-3f74.up.railway.app/searchbydatecash", {
        method: "post",
  ...
  const onGridReady = async () => {
    let result = await fetch("https://server-production-3f74.up.railway.app/getpaisaslip", {
      method: "GET",
...
//****************************Send Data to Print Cash Slip********************* */
  const sendprintdata = async (data) => {
    ...
    await axios({
      ...
      url : 'https://server-production-3f74.up.railway.app/recashprint',
      method : 'POST',
