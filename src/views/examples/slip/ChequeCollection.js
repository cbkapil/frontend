...
//**************************Get Customer List****************************** */
  const getParty = async () => {
    let result = await fetch("https://server-production-3f74.up.railway.app/getparty", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: "Bearer " + token,
...
//**************************************************** */
  const formSubmit = async (e) => {
    ...
    let result = await fetch("https://server-production-3f74.up.railway.app/createchequecollection", {
      method: "post",
      body: JSON.stringify({
        customerid,
        chequeFirmid,
...
//******************Function to Get Customer Bank********************************* */
  const getCustomerBank = async () => {
    if (!customerid) return;
      ...
      let result = await fetch("https://server-production-3f74.up.railway.app/getcustomerbank", {
        method: "post",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer " + token,
...
//*********************************************************** */
    const cusomerbankadded = async (e) => {
      ...
      let result = await fetch("https://server-production-3f74.up.railway.app/createpartybank", {
        method: "post",
        body: JSON.stringify({
          formValues,
        }),
