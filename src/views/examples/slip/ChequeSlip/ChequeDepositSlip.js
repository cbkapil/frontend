...
const [docno,setdocno]=useState(0)
    ...
    const getFirmChequeSlip = async () => {
        let result = await fetch("https://server-production-3f74.up.railway.app/getuser", {
          method: "GET",
          headers: {
...
console.log("====================>>>>>>> ",chequeFirmid)
        ...
        let result = await fetch("https://server-production-3f74.up.railway.app/getbank2", {
          method: "post",
  ...
  // ****************Remove Duplicates ************************
   ...
   const getChequeBranch = async () => {
    ...
    if (chequeFirmid && chequeBankid) {
        ...
        let result = await fetch("https://server-production-3f74.up.railway.app/getbranches", {
          method: "post",
  ...
  const getChequeAccount = async () => {
    ...
    if (chequeFirmid && chequeBankid && chequeBranchid) {
      ...
      let result = await fetch("https://server-production-3f74.up.railway.app/getaccount", {
        method: "post",
  ...
  const getdocno= async () => {
     ...
     if (chequeBankid){
      ...
      console.log("me hu console.log");
      let result = await fetch("https://server-production-3f74.up.railway.app/getdocno", {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: "Bearer " + token,
...
console.log(docno)
  ...
  const searchbydate = async (e) => {
    ...
    if ((chequeFirmid || chequefirmname)&& todate) {
      let result = await fetch("https://server-production-3f74.up.railway.app/searchbydatecheque", {
        method: "post",
...
console.log("chequedata",dataa)
  if (accountno && chequeBankid && chequeBranchid ) {
    ...
    let result = await fetch("https://server-production-3f74.up.railway.app/createchequeslip", {
      method: "post",
...
//       let result = await fetch("https://server-production-3f74.up.railway.app/senddocketdata", {
//         method: "post",
...
//   };
  ...
  const sendprintdata = async (dataa) => {
    ...
    if((chequeBankid === '') ||  chequeBranchid === '' ||  accountno === ''){
      ...
      await axios({
        ...
        url : 'https://server-production-3f74.up.railway.app/chequeprint',
        method : 'POST',
  ...
  const searchbytext = async () => {
    console.log("hi from search");
    if (searchtext) {
      let result = await fetch("https://server-production-3f74.up.railway.app/searchbyword", {
        method: "post",
  ...
  const handleRowUpdate = async (newData, oldData, resolve) => {
    ...
    let result = await fetch(`https://server-production-3f74.up.railway.app/updatecheque/${newData._id}`, {
      method: "put",
      body: JSON.stringify({
        newData,
      }),
  ...
  const getData = async () => {
    let result = await fetch("https://server-production-3f74.up.railway.app/getbank", {
      method: "GET",
  ...
  const onGridReady = async () => {
    let result = await fetch("https://server-production-3f74.up.railway.app/getchequeslips", {
      method: "GET",
